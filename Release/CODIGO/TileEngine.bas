...
Public Type Char
    ...
    Inmo As Byte
    Lanzando As Byte
    ComportamientoHechizos As Byte
    ComportamientoPotas As Byte
    ComportamientoCombo As Byte
    ...
    ModEvasion As Single
    ModAtaqueArma As Single
    ModDañoArma As Single
    ModAtaqueProyectil As Single
    ModDañoProyectil As Single
    ModEscudo As Single
    
    Contador As tCounters
...
'*****************************************************************
    ...
    With charlist(CharIndex)
        ...
        If .Bot = 1 Then _
            Call ServerSendData(SendTarget.ToAllButIndex, UserCharIndex, PrepareMessageCharacterMove(CharIndex, nX, nY))
        ...
        For X = minX To maxX
            ...
            With MapData(X, Y)
                ...
                If .CharIndex <> 0 Then
                    ...
                    If Hosting Then charlist(.CharIndex).Found = 1
                End If
                '*************************************************
        ...
        For i = 1 To MaxUsers
            If charlist(i).ConnID <> -1 Or charlist(i).Bot = 1 Then
                If charlist(i).Active Then
                    If charlist(i).Found = 1 Then
                        charlist(i).Found = 0
                    Else
                        Call CharRender(i, 1000, 1000)
                    End If
                End If
            End If
        Next i
...
'***************************************************
    ...
    If EngineRun Then
        ...
        #If ModoDebug Then
            Call Mod_TileEngine.RenderText(260, 260, "BotHP: " & charlist(2).MinHP & "/" & charlist(2).MaxHP, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 270, "BotMP: " & charlist(2).MinMAN & "/" & charlist(2).MaxMAN, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 280, "Lanzando: " & charlist(2).Lanzando, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 290, "ComP: " & charlist(2).ComportamientoPotas, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 300, "ComH: " & charlist(2).ComportamientoHechizos, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 310, "ComC: " & charlist(2).ComportamientoCombo, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 320, "TipoP: " & charlist(2).TipoPocion, vbYellow, frmMain.RecTxt.font)
            Call Mod_TileEngine.RenderText(260, 330, "Quieto: " & charlist(1).Quieto, vbYellow, frmMain.RecTxt.font)
        #End If

        If pausa Then
            Call Mod_TileEngine.RenderText(480, 260, ">JUEGO PAUSADO<", vbYellow, frmMain.RecTxt.font)
        End If
                    ...
                    If LenB(.Nombre) > 0 Then
                        If Nombres Then
                            ...
                            If .priv = 0 Then
                                ...
                                Else
                                    If EnTeam(CharIndex) = 1 Or .Team = 1 Then
                            ...
                            If CharIndex = UserCharIndex Then
                                ...
                                BackBox.Bottom = PixelOffsetY + .body.HeadOffset.Y + OFFSET_HEAD
                                BackBox.Top = PixelOffsetY + .body.HeadOffset.Y + OFFSET_HEAD - 10
                                BackBox.Left = PixelOffsetX + .body.HeadOffset.X - 10
                                BackBox.Right = PixelOffsetX + .body.HeadOffset.X + 45
                                
                                tmpSta = .MinSTA
                                StaBox.Bottom = BackBox.Bottom
                                StaBox.Top = BackBox.Top
                                StaBox.Left = BackBox.Left
                                StaBox.Right = BackBox.Left + 55 * (tmpSta * 100 / .MaxSTA) / 100
                                
                                Call BackBufferSurface.BltColorFill(BackBox, RGB(0, 0, 0))
                                Call BackBufferSurface.BltColorFill(StaBox, RGB(0, 255, 255))
                                Call RenderTextCentered((BackBox.Right + BackBox.Left) / 2 + 3, BackBox.Top - 1, .MinSTA & "/" & .MaxSTA, RGB(255, 255, 255), frmMain.font)
                            End If
                        End If
                    End If
                End If
