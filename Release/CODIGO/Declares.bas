...
Public Type tPendiente
    Slot As Integer
    Datos() As Byte
End Type

Public Pendiente() As tPendiente

Public Const MaxUsers As Byte = 10
Public LastUser As Integer

Public Type tPrioridad
    Char As Integer
    Probabilidad As Byte
End Type

Public Prioridad1(1 To 5) As tPrioridad 'Prioridad de ser targeteado del equipo del usuario
Public Prioridad2(1 To 5) As tPrioridad 'Prioridad de ser targeteado del equipo enemigo

Public SinResu As Byte
Public ResuNoVida As Byte
...
Public TeamData1(1 To 5) As tTeamData
Public TeamData2(1 To 5) As tTeamData

Public Team1() As Integer
Public Team2() As Integer

Public PathBalance As String

Public ModBalance As Byte '1=13.0 2=1.0
Public ItemData(1 To 4) As tItemData
Public StaClase(0 To 6) As Byte
Public PrioridadClase(0 To 6) As Byte
Public PrioridadRaza(0 To 4) As Byte
Public VidaClase(0 To 6) As Single
Public VidaRaza(0 To 4) As Single
Public ManaBaseClaseRaza(0 To 6, 0 To 4) As Byte
Public ManaBaseModifClase(0 To 6) As Single
Public ManaStartClase(0 To 6) As Byte
Public MinHitClase(0 To 6) As Byte
Public MaxHitClase(0 To 6) As Byte
Public FuerzaRaza(0 To 4) As Byte
Public AgilidadRaza(0 To 4) As Byte
Public BodyClaseRaza(0 To 6, 0 To 4) As Byte
Public HeadRazaGenero(0 To 4, 0 To 1) As Byte
Public ArmaClase(0 To 6) As Byte
Public EscudoClase(0 To 6) As Byte
Public CascoClase(0 To 6) As Byte
Public MinArmaClase(0 To 6) As Byte
Public MaxArmaClase(0 To 6) As Byte
Public MinDefBClase(0 To 6) As Byte
Public MaxDefBClase(0 To 6) As Byte
Public MinDefHClase(0 To 6) As Byte
Public MaxDefHClase(0 To 6) As Byte
Public MinRMClase(0 To 6) As Byte
Public MaxRMClase(0 To 6) As Byte
Public MinDMClase(0 To 6) As Byte
Public MaxDMClase(0 To 6) As Byte
Public ModEvasionClase(0 To 6) As Single
Public ModAtaqueArmaClase(0 To 6) As Single
Public ModAtaqueProyectilClase(0 To 6) As Single
Public ModDañoArmaClase(0 To 6) As Single
Public ModDañoProyectilClase(0 To 6) As Single
Public ModEscudoClase(0 To 6) As Single
Public ModDMClase(0 To 6) As Single

Public BotMatados As Byte

Public CuentaR As Byte
Public EnCuenta As Boolean

Public ModoDebug As Byte

Public Dificultad As Byte

Public DGanados As Integer
Public DPerdidos As Integer

Public CFalla As Integer
Public CPega As Integer

Public MySpell As String
...
Public Hechizo(1 To 6) As tHechizos
...
Public CharTimer() As New clsTimer
...
Public Const INT_ATTACK_CAST As Integer = 1000
Public Const INT_WORK As Integer = 700
Public Const INT_USEITEMU As Integer = 450
Public Const INT_USEITEMDCK As Integer = 200
Public Const INT_MINU As Integer = 200
Public Const INT_SENTRPU As Integer = 2000
Public Const INT_GOLPEU As Integer = 1200
Public Const INT_PASOIH As Integer = 1200
Public Const INT_REMO As Integer = 500
Public Const INT_REMOOTRO As Integer = 1000
Public Const INT_RESU As Integer = 1000
Public Const INT_LAN As Integer = 300
...
Public UserGenero As Byte
Public UserTeam As Byte
...
Public ListaClases(0 To NUMCLASES) As String
